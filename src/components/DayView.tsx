        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <div>
            <h2 className="text-sm sm:text-lg font-bold text-slate-800 dark:text-slate-100 flex items-center gap-1.5 sm:gap-2">
              <Calendar className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-orange-500 dark:text-orange-400" />
              {day.date}
            </h2>
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-medium">{day.title}</p>
          </div>
        </div>
      </div>
